...
--
-- Name: elements alements_unique_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT alements_unique_name UNIQUE (name);


--
-- Name: elements alements_unique_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT alements_unique_symbol UNIQUE (symbol);
